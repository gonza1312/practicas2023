...
//        double resultado = ListaNumeros.promedioEscuela(List.of(10D, 4.5, 8D), List.of(9.3, 8.7));;
//        ImprimePantalla.imprimirFrase("El valor mas repetido de la lista es: "+resultado);
//        double resultado = ListaNumeros.promedioEscuelaCon1For(List.of(List.of(10D, 4.5, 8D), List.of(9.3, 8.7)));
//        ImprimePantalla.imprimirFrase("El promedio de la escuela es: " + resultado);
        double resultado = ListaNumeros.promedioGralEscuela2(List.of(List.of(10D, 4.5, 8D), List.of(9.3, 8.7)));
        ImprimePantalla.imprimirFrase("El promedio de la escuela es: " + resultado);
    }
}
